          ...
          <Col lg="6" md="6">
            <div className="about__section-content">
              ...
              <div className="about__section-item d-flex align-items-center">
                ...
                <p className="section__description d-flex align-items-center gap-2">
                  <i class="ri-checkbox-circle-line"></i> Exceeding your expectations is our standard practice.
                </p>
              </div>

              <div className="about__section-item d-flex align-items-center">
                <p className="section__description d-flex align-items-center gap-2">
                  <i class="ri-checkbox-circle-line"></i> Your satisfaction is our top priority, Always.
                </p>

                <p className="section__description d-flex align-items-center gap-2">
                  <i class="ri-checkbox-circle-line"></i> We aim to astonish you with our service.
                </p>
              </div>
            </div>
          </Col>
